...
export class FooterBuilder {
    ...
    private Add(params: {dataSlice: FooterItemData[], options: Partial<PartOptions>}) : JSX.Element {
        ...
        let positionClassName = params.options.position === 'center' ? positionModality.CENTER : (params.options.position === 'left' ? positionModality.LEFT : positionModality.RIGHT);
